...
BoxIntersection.prototype.updateFrustum = function ( startPoint, endPoint ) {
	...
	vecTopLeft = vector3ApplyProjection( vecTopLeft, tmpMat );
	vecTopRight = vector3ApplyProjection( vecTopRight, tmpMat );
	vecDownRight = vector3ApplyProjection( vecDownRight, tmpMat );
	vecDownLeft = vector3ApplyProjection( vecDownLeft , tmpMat );

	vecFarTopLeft = vector3ApplyProjection( vecFarTopLeft, tmpMat );
	vecFarTopRight = vector3ApplyProjection( vecFarTopRight, tmpMat );
	vecFarDownRight = vector3ApplyProjection( vecFarDownRight, tmpMat );
	vecFarDownLeft = vector3ApplyProjection( vecFarDownLeft , tmpMat );
